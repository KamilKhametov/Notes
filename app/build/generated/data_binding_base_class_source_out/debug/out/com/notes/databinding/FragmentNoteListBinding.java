...
public final class FragmentNoteListBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton createNoteButton;
  ...
  private FragmentNoteListBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton createNoteButton, @NonNull RecyclerView list,
  ...
  public static FragmentNoteListBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.createNoteButton;
      FloatingActionButton createNoteButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentNoteListBinding((ConstraintLayout) rootView, createNoteButton, list,
          toolbar);
    }
